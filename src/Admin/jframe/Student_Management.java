...
public class Student_Management extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        studentAdmission = new javax.swing.JButton();
        ...
        studentAdmission.setText("Student's Admission");
    ...
    private void courseManagementActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_courseManagementActionPerformed
        ...
        try {
            obj.setVisible(false);
            new Student_courseManagement().main();
        } catch (Exception ex) {
            Logger.getLogger(EditManu.class.getName()).log(Level.SEVERE, null, ex);
        }
...
//    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
               obj= new Student_Management();obj.setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton studentAdmission;
